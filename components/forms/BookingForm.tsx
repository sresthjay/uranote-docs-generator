...
export default function BookingForm({
  ...
  function handleSave(
    section: "receipt" | "voucher" | "payment"
  ) {
    ...
    // 1. Set to saving state immediately
    setSaveState('saving');

    // 2. Wait 2 seconds, then set to saved
    setTimeout(() => {
      setSavedSection(section);
      setSaveState('saved');

      // 3. Reset back to idle after 3 seconds (optional)
      setTimeout(() => {
        setSaveState('idle');
      }, 1000);
    }, 750);
          ...
          <div className="mt-6 border-t border-gray-200 pt-5">
            ...
            <div className="flex flex-wrap items-center justify-end gap-3">
              ...
              <button
                ...
                className={`
    flex items-center justify-center gap-2 rounded border px-5 py-2.5 text-sm font-medium transition-colors duration-200
    ${saveState === 'saved'
